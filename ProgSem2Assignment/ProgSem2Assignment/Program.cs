...
namespace KeepingScores
{
    class Program
    {
        ...
        static void VesselSortAndTotal(int[] totlas, int f)
        {
            switch(f)
            {
                case 1:
